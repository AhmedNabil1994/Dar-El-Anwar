...
class SupportTicketController extends Controller
{
    ...
    public function __construct(Ticket $modalTicket, Department $modelTicketDepartment, TicketPriority $modelTicketPriority, TicketRelatedService $modelTicketService)
    {
