...
class AffiliateController extends Controller
{
    ...
    public function affiliateRequestList()
    {
        ...
        $data['requestsAll'] = AffiliateRequest::all();
        $data['requestsApproved'] = AffiliateRequest::where(['status'=>STATUS_APPROVED])->get();
        $data['requestsSuspend'] = AffiliateRequest::where(['status'=>STATUS_REJECTED])->get();
        $data['requestsPending'] = AffiliateRequest::where(['status'=>STATUS_PENDING])->get();
