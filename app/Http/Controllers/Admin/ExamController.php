...
class ExamController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->question_name as $index => $question_name){
            $data_exam = [
                'name' => $question_name,
                'type' => $request->review_type[$index],
                'exam_id' => $exam->id,
            ];
    ...
    public function update(Request $request, $uuid)
    {
        ...
        $exam = $this->model->update($data_exam,$uuid);
        $data_exam = [
            'name' => $request->question_name,
            'type' => $request->review_type,
            'exam_id' => $exam->id,
        ];
        $questions_ids = $exam->questions->pluck('id');
        Question::whereIn('id', $questions_ids)->delete();
    ...
    public function question($uuid)
    {
        ...
        if ($data['exam']->type == 'true_false')
        {
            return view('instructor.course.exam.question.true-false', $data);
        }  else {
            return view('instructor.course.exam.question.multiple-choice', $data);
        }
    }
    ...
    public function editMcq($question_uuid)
    {
        ...
        return view('instructor.course.exam.question.edit-mcq', $data);
    }
    ...
    public function updateMcqQuestion(Request $request, $question_uuid)
    {
        ...
        return redirect()->route('exam.view', [$question->exam->uuid]);
    }
    ...
    public function editTrueFalse($question_uuid)
    {
        ...
        $data['question'] = $this->questionModel->getRecordByUuid($question_uuid);
        $data['exam'] = $data['question']->exam;
        return view('instructor.course.exam.question.edit-true-false', $data);
    }
