...
class SubscriptionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['subscriptions'] = StudentSubscription::query()->orderBy('id','DESC')
            ->where('student_id', Auth::guard('students')->id())->with('student')->paginate(25);

        return view('student.subscription.list', $data);
    }
