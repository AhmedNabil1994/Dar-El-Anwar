...
class ChatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('student.chats.index', compact('chat_threads'));
    }
    ...
    {
        //
        $chatThread = ChatThread::where( 'user_id',$request->instructor)
            ->where('sender_id' , Auth::guard('students')->id())
        ->first();
        ...
        return view('student.chats.show', compact('chatThread'));
    }
    ...
    public function refresh(Request $request)
    {
        ...
        return [
            'view' => view('student.chats.refresh', compact('chats'))->render(),
