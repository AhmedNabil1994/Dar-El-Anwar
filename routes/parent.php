...
Route::group(['middleware' => ['parents']], function () {
    Route::get('student/logout', [ParentController::class, 'logout'])->name('logout');

    Route::get('/home', [\App\Http\Controllers\HomeController::class, 'index'])->name('home');
});

Route::group(["middleware"=> \App\Http\Middleware\Parents::class],function (){

    Route::get('dashboard', [\App\Http\Controllers\Admin\DashboardController::class, 'parent_dashboard'])->name('dashboard');

        Route::get('my_profile', [ParentController::class, 'profile'])->name('profile');
...
//        Route::post('update/{id}', [FinancialAccountController::class, 'update'])->name('student.update');
    ...
    Route::prefix('parent')->group(function (){
        Route::post('parent_update/{parent}', [ParentController::class, 'parent_update'])->name('parent_update');
    });
