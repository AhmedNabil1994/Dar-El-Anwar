            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="sign-up-right-content bg-white">
                        <form method="POST" action="{{route('admins.store.sign-up')}}">
                            @csrf
                            ...
                            <div class="row mb-30">
                                <div class="col-md-6">
                                    <label class="label-text-title color-heading font-medium font-16 mb-3" for="user_name">{{__('User Name')}}</label>
                                    <input type="text" name="user_name" id="user_name" value="{{old('User Name')}}" class="form-control" placeholder="{{__('User Name')}}">
                            ...
                            <div class="row mb-30">
                                <div class="col-md-6">
                                    <label class="label-text-title color-heading font-medium font-16 mb-3" for="phone">{{__('Phone')}}</label>
                                    <input type="text" name="phone" id="user_name" value="{{old('Phone')}}" class="form-control" placeholder="{{__('Phone')}}">
                                    @if ($errors->has('phone'))
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="last_name" id="last_name" value="{{old('last_name')}}" class="form-control" placeholder="{{__('Last Name')}}">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    <button type="submit" class="theme-btn theme-button1 theme-button3 font-15 fw-bold w-100">{{__('Sign Up')}}</button>
                                </div>
                            </div>
