                ...
                <div class="col-lg-4 col-md-5">
                    <div class="profile__item bg-style">
                        <div class="profile__item__top">
                            <div class="user-img">
                                <img src="{{asset($instructor->employee->getImg())}}" alt="img">
                            </div>
                            <div class="user-text">
                                <h2>{{$instructor->employee->name}}</h2>
                                <h3>{{$instructor->employee->job_title}}</h3>
                            </div>
                        </div>
                        ...
                        <ul class="profile__item__list">
                            <li>
                                <div class="list-item">
                                    <h2>{{__('Name')}}:</h2>
                                    <p>{{$instructor->employee->name}}</p>
                                </div>
                            </li>
                            <li>
                                <div class="list-item">
                                    <h2>{{__('Phone')}}:</h2>
                                    <p>{{$instructor->employee->phone}}</p>
                                </div>
                            </li>
                            <li>
                                <div class="list-item">
                                    <h2>{{__('Email')}}:</h2>
                                    <p>{{$instructor->employee ? $instructor->employee->email : '' }}</p>
                                </div>
                            </li>
                            <li>
                                <div class="list-item">
                                    <h2>{{ __('Address') }}:</h2>
                                    <p>{{$instructor->employee->address}} </p>
                                </div>
                            </li>
{{--                            <li>--}}
{{--                                <div class="list-item">--}}
