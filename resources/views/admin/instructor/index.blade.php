                            ...
                            <table id="customers-table" class="row-border data-table-filter table-style">
                                ...
                                @foreach($instructors as $instructor)
                                    <tr class="removable-item">
                                        <td>
                                           <img src="{{asset($instructor->employee->getImg())}}" width="80">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                <a href="{{route('instructor.view', [$instructor->id])}}" class="btn-action mr-30" title="View Details">
                                                    <img src="{{asset('admin/images/icons/eye-2.svg')}}" alt="eye">
                                                </a>
                                                <a href="{{route('instructor.edit', [$instructor->id])}}" class="btn-action mr-30" title="Edit Details">
                                                    <img src="{{asset('admin/images/icons/edit-2.svg')}}" alt="edit">
                                                </a>
                                                <a href="javascript:void(0);" data-url="{{route('employees.delete', $instructor->employee->id)}}" title="Delete" class="btn-action delete">
