                        ...
                        <div class="card-body">
                            <div class="d-grid">
                                <button class="btn font-16 btn-primary" id="btn-new-event"><i
                                        class="mdi mdi-plus-circle-outline"></i> اضافة تذكير
                                </button>
                            </div>
                        ...
                        <div class="modal-body p-4">
                            <form class="needs-validation" name="event-form" id="form-event" novalidate>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label">عنوان التذكير</label>
                                            <input class="form-control" placeholder="ادخل عنوان التذكير"
...
{{--                                    </div>--}}
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-6 text-end">
                                        <button type="button" class="btn btn-light me-1" data-bs-dismiss="modal">{{__('website.cancel')}}
                                        </button>
                                        <button type="submit" class="btn btn-success" id="btn-save-event">{{__('website.save')}}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
