                                                            ...
                                                            <div class="certificate-inner-box">
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-15">
                                                                            ...
                                                                            <input type="text" name="title" required value="{{old('title')}}" class="form-control" placeholder="{{ __('Certificate Title') }}">
                                                                            @if ($errors->has('title'))
                                                                        ...
                                                                        <div class="col-md-12 mb-15">
                                                                            ...
                                                                            <div class="admin-certificate-radio d-flex align-items-center">
                                                                                ...
                                                                                <div class="form-check mb-0 d-flex align-items-center">
                                                                                    ...
                                                                                    <label class="form-check-label mb-0 color-heading" for="exampleRadios2">{{ __('No') }}</label>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="certificate-inner-box">
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-15">
                                                                            <div class="label-text-title color-heading font-16 mb-1">{{ __('Title') }}</div>
                                                                            <input type="text" name="role_1_title" value="{{old('role_1_title')}}" class="form-control" placeholder="{{ __('Administrator') }}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-15">
                                                                            ...
                                                                            <div class="recomended-size-for-img font-12">{{ __('Recommend Size') }}: 120 x 60</div>
