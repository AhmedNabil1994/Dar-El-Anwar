                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <textarea class="form-text" style="height: 150px" name="adherence_to_the_recitation_plan_and_the_amount_of_review_scheduled_for_the_students_records">{{get_follow_up_rsponse($followup->id,'adherence_to_the_recitation_plan_and_the_amount_of_review_scheduled_for_the_students_records')}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <textarea class="form-text" style="height: 150px" name="proficiency_in_identifying_students_errors_during_listening_and_addressing_those_errors">{{get_follow_up_rsponse($followup->id,'proficiency_in_identifying_students_errors_during_listening_and_addressing_those_errors')}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <textarea class="form-text" style="height: 150px" name="monitoring_students_regularity_and_attendance_on_time_and_following_up_on_absent_students">{{get_follow_up_rsponse($followup->id,'monitoring_students_regularity_and_attendance_on_time_and_following_up_on_absent_students')}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <textarea class="form-text" style="height: 150px" name="commitment_to_restricting_grants_to_students_who_are_on_leave_and_at_the_levels_specified_for_the_leave">{{get_follow_up_rsponse($followup->id,'commitment_to_restricting_grants_to_students_who_are_on_leave_and_at_the_levels_specified_for_the_leave')}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <textarea class="form-text" style="height: 150px" name="proficiency_among_those_who_have_weakness_in_reading_and_intonation">{{get_follow_up_rsponse($followup->id,'proficiency_among_those_who_have_weakness_in_reading_and_intonation')}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <textarea class="form-text" style="height: 150px" name="which_archives_exist_for_more_than_two_cycles_for_the_entire_archive">{{get_follow_up_rsponse($followup->id,'which_archives_exist_for_more_than_two_cycles_for_the_entire_archive')}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <textarea class="form-text" style="height: 150px" name="notes_about_the_level_of_some_students_and_their_notebookt">{{get_follow_up_rsponse($followup->id,'notes_about_the_level_of_some_students_and_their_notebookt')}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
