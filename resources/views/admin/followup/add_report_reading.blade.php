                    ...
                    <div class="breadcrumb__content">
                        <div class="breadcrumb__content__left">
                            <div class="breadcrumb__title">
                                ...
                                <h2>{{ trans('تقرير متابعة  القراءة') }}</h2>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="customers__area bg-style mb-30">
                        ...
                        <form action="{{route('admin.followup.storeReading')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>تنظيم جلوس الطلاب وحقائبهم<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>العدل في توزيع المشاركات<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>جذب انتباه جميع الطلاب<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>مدى حسن إدارة الوقت<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>مدى حسن استخدام الوسائل<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>كيفية إدارة المعلم للتقويم بالمراجعة<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>ملاحظات عامة حول مستوى الطلاب بالمراجعة<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>مدى الجودة في التمهيد للجديد والربط مع الدروس السابقة<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>مدى كفاية شرح الدرس الجديد وتنوع الأمثلة<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>كيفية تقويم المعلم لمستوى استيعاب الطلاب للدرس الجديد<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>ملاحظات حول استيعاب الطلاب للدرس الجديد<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label>ملاحظات حول مستوى بعض الطلاب ودفاترهم<span class="text-danger">*</span></label>
