                        ...
                        <div class="card-body">
                            <form method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="upload-img-box mb-25">
                                                ...
                                                <img id="upload-img-box-icon" src="{{asset($employee->getImg())}}"
                                                     alt="صورة الموظف"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3 mb-4">
                                        ...
                                        <div class="col-md-12">
                                            <select  id="job_title" type="text" class="form-control @error('job_title') is-invalid @enderror" name="job_title" value="{{ old('job_title', $employee?->job_title) }}"  autocomplete="job_title">
                                                ...
                                                <option value="teacher" {{$employee->job_title == 'teacher' ? 'selected' : ''}}>{{trans("website.teacher")}}</option>
                                                <option value="driver" {{$employee->job_title == 'driver' ? 'selected' : ''}}>{{trans("website.driver")}}</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="form-group col-md-6 mb-4">
                                        <label for="address" class="form-label text-md-right">{{ trans('website.address') }} <span class="required-star">*</span></label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-3 mb-4">
                                        <label for="departure_time" class=" form-label text-md-right">
                                    ...
                                    <div class="form-group col-md-3 mb-4">
                                        <label for="attendance_time" class=" form-label text-md-right">
                                        ...
                                        <select type="text"
                                            ...
                                            @foreach($roles as $role)
                                                <option value="{{$role->id}}"
                                                    {{$role->id == $employee->roles->first()?->id ? 'selected' : ''}}
                                                >{{$role->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div id="dependentDiv" style="display: none;">
                                        ...
                                        <div class="form-group col-md-3 mb-4">
                                            <label for="password-confirm" class=" form-label text-md-right">{{ __('تأكيد كلمة السر') }}
                                                <span class="required-star">*</span></label>
                                            <div class="col-md-12">
