            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="customers__area bg-style mb-30">
                        ...
                        <div class="card-body">
                            <form method="POST" class="row" action="{{ route('admin.assignments.assignment.update',$assignment) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="form-group col-md-3  mb-4">
                                        ...
                                        <div class="col-md-12">
                                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                                   value="{{ $assignment->name }}"  autocomplete="name" required>
                                            @error('name')
