                    ...
                    <div class="form-horizontal__item bg-style">
                        ...
                        <form action="{{route('role.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="custom-form-group mb-3 row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="name" id="name" value="{{old('name')}}" class="form-control flat-input" placeholder="{{__('website.name')}}">
                                    @if ($errors->has('name'))
                                       ...
                                       @foreach($permissions as $permission)
                                           <div class="col-md-4 mb-2">
                                               <div class="form-check mb-0 d-flex align-items-center">
                                                   <input class="form-check-input mx-3" type="checkbox" name="permissions[]" id="permission{{$permission->id}}" value="{{$permission->id}}" >
