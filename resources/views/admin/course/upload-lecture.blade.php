                                    ...
                                    <div id="upload-course-video-4" >
                                        <div class="upload-course-item-block course-overview-step1 radius-8">
                                                ...
                                                <div class="row mb-30">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select name="vimeo_upload_type" class="form-select vimeo_upload_type">
                                                            ...
                                                            <option value="1" @if(old('vimeo_upload_type') == 1) selected @endif >{{ __('Video File Upload') }}</option>
                                                            <option value="2" @if(old('vimeo_upload_type') == 2) selected @endif >{{ __('Vimeo Uploaded Video ID') }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="text" class="d-none">
                                                ...
                                                <textarea name="text_description" id="summernote" class="textDescription" cols="30" rows="10">{{ old('text_description') }}</textarea>
                                            </div>
                                            ...
                                            <div id="pdfDiv" class="d-none">
                                                ...
                                                <div class="upload-course-video-4-wrap upload-introduction-box-content-left d-flex align-items-center flex-column">
                                                    ...
                                                    <input type="file" name="pdf" accept="application/pdf" class="form-control" value="{{ old('pdf') }}" id="pdf" title="Upload lesson pdf" >
                                                </div>
                                            </div>
                                            <div id="slide_documentDiv" class="d-none">
                                                ...
                                                <div class="upload-course-video-4-wrap upload-introduction-box-content-left d-flex align-items-center flex-column">
                                                    <input type="text" name="slide_document" class="form-control" value="{{ old('slide_document') }}" id="slide_document" title="Upload lesson slide document" >
                                                </div>
                                            </div>
                                            <div id="audioDiv" class="d-none">
                                                ...
                                                <div class="upload-course-video-4-wrap upload-introduction-box-content-left d-flex align-items-center flex-column">
                                                    ...
                                                    <input type="file" name="audio" class="form-control" value="{{ old('audio') }}" id="audio" title="Upload lesson audio" >
                                                </div>
                                            </div>
                                            <div>
                                            ...
                                            <div class="main-upload-video-processing-box">
                                                <div class="d-flex main-upload-video-processing-item">
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="row mb-30">
                                                            <div class="col-md-12">
                                                                <label class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Learner\'s Visibility') }} <span class="text-danger">*</span></label>
                                                                <select name="lecture_type" class="form-select" required>
                                                                    <option value="" >--Select Option--</option>
                                                                    <option value="1" @if(old('lecture_type') == 1) selected @endif >{{ __('Show') }}</option>
                                                                    <option value="2" @if(old('lecture_type') == 2) selected @endif >{{ __('Lock') }}</option>
                                                                </select>
                                                            </div>
                                                        </div>
