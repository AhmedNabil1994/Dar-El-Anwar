                                        ...
                                        <div id="upload-course-video-4" >
                                            <div class="upload-course-item-block course-overview-step1 radius-8">
                                                ...
                                                <div class="row mb-30">
                                                    <div class="col-md-12">
                                                        <div class="d-flex">
                                                            <div class="label-text-title color-heading font-medium font-16 mb-3 mr-15">{{ __('Type:') }} </div>
                                                            <div>
                                                                <label class="mr-15"><input type="radio" name="type" value="video" {{$lecture->type == 'video' ? 'checked' : '' }}  class="lecture-type"> {{ __('Upload Video') }}</label>
                                                                ...
                                                                <label class="mr-15"><input type="radio" name="type" value="text" {{$lecture->type == 'text' ? 'checked' : '' }} class="lecture-type" id="lectureTypeText"> {{ __('Text') }} </label>
                                                                <label class="mr-15"><input type="radio" name="type" value="image" {{$lecture->type == 'image' ? 'checked' : '' }} class="lecture-type" id="lectureTypeImage"> {{ __('Image') }} </label>
                                                                <label class="mr-15"><input type="radio" name="type" value="pdf" {{$lecture->type == 'pdf' ? 'checked' : '' }} class="lecture-type" id="lectureTypePDF"> {{ __('PDF') }} </label>
                                                                <label class="mr-15"><input type="radio" name="type" value="slide_document" {{$lecture->type == 'slide_document' ? 'checked' : '' }} class="lecture-type" id="lectureTypeSlideDocument"> {{ __('Slide Document') }} </label>
                                                ...
                                                <div id="youtube" class="{{$lecture->type == 'youtube' ? '' : 'd-none' }}">
                                                    <input type="text" name="youtube_url_path" id="youtube_url_path"  value="{{$lecture->type == 'youtube' ? $lecture->url_path : ''}}" class="form-control youtube-url" placeholder="{{ __('Type Your Youtube Video ID') }}">
                                                    ...
                                                    <div class="vimeo_uploaded_Video_id_div {{ $lecture->vimeo_upload_type == 2 ? '': 'd-none' }}">
                                                        <div class="row mb-30">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="upload-course-video-4-wrap upload-introduction-box-content-left d-flex align-items-center flex-column">
                                                                    <input type="text" name="vimeo_url_uploaded_path" placeholder="{{ __('Type your uploaded video ID (ex: 123654)') }}" class="form-control" value="{{ $lecture->url_path }}" id="vimeo_url_uploaded_path">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row mb-30">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" name="vimeo_file_duration" value="{{ $lecture->file_duration }}" class="form-control customVimeoFileDuration" placeholder="{{ __('Type file duration') }}" >
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <div class="row mb-30">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="text" name="title" value="{{$lecture->title}}" class="form-control" placeholder="{{ __('First steps') }}" required>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-30">
                                                                <div class="col-md-12">
                                                            ...
                                                            <div class="row mb-30 d-none" id="fileDuration">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="text" name="youtube_file_duration" value="{{$lecture->file_duration}}" class="form-control customFileDuration" placeholder="{{ __('First file duration') }}">
