                            ...
                            <div class="breadcrumb__content__right">
                                <nav aria-label="breadcrumb">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">{{ trans('اضف فرع') }}</li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="text" name="branch_name" value="{{old('branch_name')}}" placeholder="{{ trans('website.typeSubjectName') }}"
