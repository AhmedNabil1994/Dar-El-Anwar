                        ...
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('ranking.index')}}">{{ __('All Ranking Level') }}</a></li>
                        ...
                        <form action="{{route('ranking.update', [$level->uuid])}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-2">
                                    ...
                                    @endif
                                    <p>{{ __('Accepted Image Files') }}: PNG,JPG <br> {{ __('Accepted Size') }}: 86 x 66 (1MB)</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="name" value="{{$level->name}}" placeholder="{{ __('Type name') }}" class="form-control">
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="number" name="serial_no" value="{{$level->serial_no}}" placeholder="{{ __('Type serial no') }}" class="form-control" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label for="earning">{{ __('Earning') }} <span class="text-danger">*</span></label>
                                        <input type="number" name="earning" value="{{$level->earning}}" placeholder="{{ __('Type name') }}" class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        <label for="student">{{ __('Student') }} <span class="text-danger">*</span></label>
                                        <input type="number" name="student" id="student" placeholder="{{ __('Type student') }}"
                                               value="{{ $level->student }}"
