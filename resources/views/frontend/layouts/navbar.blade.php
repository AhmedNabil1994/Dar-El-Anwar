<section class="menu-section-area @auth isLoginMenu @endauth">
    ...
    <nav class="navbar sticky-header navbar-expand-lg" id="mainNav">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ getImageFile(get_option('app_logo')) }}" alt="Logo" style="width:80px; height:80px;"></a>
                      ...
                      {{--      <ul class="dropdown-menu {{selectedLanguage()->rtl == 1 ? 'dropdown-menu-end' : ''}}">
                        ...
                        @if(@auth::user()->role == 2 || @auth::user()->role == 3)
                            ...
                            @if(@auth::user()->role == 3 )
                                ...
                                @else
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('student.become-an-instructor')}}">{{__('Become an Instructor')}}</a>
                                    </li>
                                @endif
                                                        ...
                                                        <div class="message-user-item-left">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1 {{selectedLanguage()->rtl == 1 ? 'me-2' : 'ms-2' }}">
                                                                    <h6 class="color-heading font-14">{{$student_notification->sender->name}}</h6>
                                                    ...
                                                    <a href="{{route('notification.url', [$instructor_notification->uuid])}}" class="message-user-item d-flex align-items-center">
                                                        <div class="message-user-item-left">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1 {{selectedLanguage()->rtl == 1 ? 'me-2' : 'ms-2' }}">
                                                                    <h6 class="color-heading font-14">{{@$instructor_notification->sender->name}}</h6>
                                    ...
                                    <div class="dropdown-menu {{selectedLanguage()->rtl == 1 ? 'dropdown-menu-start' : 'dropdown-menu-end'}}" data-bs-popper="none">
                                        ...
                                        @if(@auth()->user()->role != 1)
                                            ...
                                            <ul class="user-dropdown-item-box">
                                                ...
                                                @if(Auth::user()->is_affiliator == AFFILIATOR || (Auth::user()->role == 2 && @Auth::user()->instructor->status == 1))
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('wallet./') }}"><span class="iconify" data-icon="et:wallet"></span>
                                                        {{ __('My Wallet') }}
                                                    </a>
                                                </li>
                                                @endif
                                            ...
                                            @if(Auth::user()->is_affiliator == NOT_AFFILIATOR && get_option('referral_status') == 1)
                                                <ul class="user-dropdown-item-box">
                                                    <li>
                                                        <a class="dropdown-item" href="{{route('affiliate.become-an-affiliate')}}"><span class="iconify" data-icon="tabler:affiliate"></span>{{__('Become an Affiliator')}}
                                                        </a>
                                                    </li>
                                                </ul>
                                            @elseif(Auth::user()->is_affiliator ==  AFFILIATE_REQUEST_PENDING && get_option('referral_status') == 1)
                                                <ul class="user-dropdown-item-box">
                                                    <li >
                                                        <a class="dropdown-item" href="#"><span class="iconify" data-icon="tabler:affiliate"></span>{{__('Affiliate Request Pending')}}
                                                        </a>
                                                    </li>
                                                </ul>
                                            @elseif(Auth::user()->is_affiliator ==  AFFILIATE_REQUEST_REJECTED && get_option('referral_status') == 1)
                                                <ul class="user-dropdown-item-box">
                                                    <li >
                                                        <a class="dropdown-item" href="#"><span class="iconify" data-icon="tabler:affiliate"></span>{{__('Affiliate Request Rejected')}}
                                                        </a>
                                                    </li>
                                                </ul>
                                            @elseif(Auth::user()->is_affiliator == AFFILIATOR)
                                                <ul class="user-dropdown-item-box">
                                                    <li>
                                                        <a class="dropdown-item" href="{{route('affiliate.dashboard')}}"><span class="iconify" data-icon="tabler:affiliate"></span>
                                                            {{__('Affiliator Panel')}}
                                                        </a>
                                                    </li>
                                                </ul>
                                        ...
                                        <ul class="user-dropdown-item-box">
                                            ...
                                            @if(\Illuminate\Support\Str::contains(url()->current(), 'students'))
                                                <li><a class="dropdown-item" href="{{route('student.logout')}}"><span class="iconify" data-icon="ic:round-logout"></span>{{__('Logout')}}</a>
                                                </li>
                                            @elseif(\Illuminate\Support\Str::contains(url()->current(), 'instructors'))
                                                <li><a class="dropdown-item" href="{{route('instructor.logout')}}"><span class="iconify" data-icon="ic:round-logout"></span>{{__('Logout')}}</a>
                                                </li>
                                            @endif
