                                ...
                                <div class="card-body flex-grow-1">
                                    ...
                                    <p class="card-text instructor-name-certificate font-medium">
                                        @if($wishlist->course_id)
                                            ...
                                            @if(get_instructor_ranking_level(@$wishlist->course->instructor->user_id))
                                                | {{ get_instructor_ranking_level(@$wishlist->course->instructor->user_id) }}
                                            @endif
                                        @elseif($wishlist->bundle_id)
                                            {{ @$wishlist->bundle->user->instructor->name }}
                                            @if(get_instructor_ranking_level(@$wishlist->course->bundle->user_id))
                                                | {{ get_instructor_ranking_level(@$wishlist->course->bundle->user_id) }}
                                            @endif
                                        @endif
