                    ...
                    <td class="wishlist-course-item">
                        <div class="card course-item wishlist-item border-0 d-flex align-items-center">
                            ...
                            <div class="card-body flex-grow-1">
                                <h5 class="card-title course-title"><a href="">{{ @$orderItem->consultationSlot->user->instructor->full_name }}</a></h5>
                                <div class="card-text font-medium font-13 mb-1">
                                    <p class="card-text instructor-name-certificate font-medium">{{ @$orderItem->consultationSlot->user->instructor->full_namee }}
                                        {{ @$orderItem->consultationSlot->user->instructor->professional_title }}
                                        @if(get_instructor_ranking_level(@$orderItem->consultationSlot->user->id))
                                            | {{ get_instructor_ranking_level(@$orderItem->consultationSlot->user->id) }}
                                        @endif
                                    </p>
