...
@section('content')
<!-- Page Header Start -->
<header class="page-banner-header gradientt-bg position-relative">
    <div class="section-overlmy">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="page-banner-content text-center" style="margin-top: 20pc;">
                        <h3 class="page-bannner-heading text-white pb-15">{{ __('About Us') }}</h3>

                        <!-- Breadcrumb Start-->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item font-14" style="color:#6c757d !important;    line-height: 22px;"><a href="{{ url('/') }}">{{__('Home')}}</a></li>
                                <li class="breadcrumb-item font-14 active" aria-current="page" style="color:#6c757d;">{{ __('About Us') }}</li>
                            </ol>
                        </nav>
                        <!-- Breadcrumb End-->
                    </div>
...
<section class="our-history-area bg-pagee section-t-space">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-title text-center">
