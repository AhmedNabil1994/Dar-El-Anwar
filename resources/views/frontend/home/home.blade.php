                ...
                <div class="row">
                    <div class="col-12 col-md-7 col-lg-5">
                        <div class="hero-content">
                            ...
                            <div class="hero-btns">
                                <a href="{{ route('courses') }}" class="theme-btn theme-button1">{{ __('لمعرفة المزيد') }} <i data-feather="arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="special-feature-area p-0 {{ @$home->special_feature_area == 1 ? '' : 'd-none' }}" >
        <div class="container" style="    padding-right: 0px;">
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="single-feature-igem d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3 feature-content">
                            <h6 style="color: white !important;">{{ __(get_option('home_special_feature_first_title')) }}</h6>
                            <p style="color:white;">{{ __(get_option('home_special_feature_first_subtitle')) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                        <div class="section-title section-title-left d-flex align-items-start">
                            ...
                            <div>
                                <h3 class="section-heading" style="color:#454445;">{{ __(get_option('course_title')) }}</h3>
...
{{--                                @endforeach--}}
    ...
    <section class="top-categories-area gradient-bg p-0 {{ @$home->top_category_area == 1 ? '' : 'd-none' }}" >
        <div class="section-ovedlay section-t-space section-b-space">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title text-center">
                            <div class="section-heading-img"><img src="{{ asset(get_option('top_category_logo')) }}" alt="Our categories"></div>
                            <h3 class="section-heading section-heading-light" style="color:#fff;">{{ __(get_option('top_category_title')) }}</h3>
                ...
                <div class="row top-categories-content-wrap">
                    @foreach(@$firstFourCategories as $firstFourCategory)
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="single-feeture-item top-cat-item align-items-center">
                                <div class="flex-shrink-0 feature-img-wrap">
                    ...
                    <div class="col-12 text-center section-btn" >
                        <a href="{{ route('courses') }}" class="theme-btn theme-button1" style="font-size:20px!important; color: #c80012!important;
    background-color: #ffffff;">{{ __('All Categories') }} <i data-feather="arrow-right"></i></a>
                    </div>
                    <!-- section button end-->
...
{{--                                <img src="{{ asset('uploads_demo/setting/consultation.png') }}" alt="Consultant">--}}
                            </div>
                            <div>
                            ...
                            <div class="col-12 col-sm-4 col-lg-3 w-100">
                                <div class="card course-item consultation-instructor-item border-0 radius-3 bg-white">
                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <p class="card-text instructor-name-certificate font-medium font-12">{{ $consultationInstructor->professional_title }} |
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="card instructor-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text instructor-designation font-medium">{{ @$instructor->professional_title }}</p>
    ...
    <section class="customers-says-area gradient-bg p-0 {{ @$home->customer_says_area == 1 ? '' : 'd-none' }}">
        <div class="section-oveslay section-t-space section-b-space">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title text-center">
                        ...
                        <div class="testimonial-item">
                            <div class="testimonial-top-content d-flex align-items-center">
                                <div class="flex-shrink-0 quote-img-wrap">
                                    <img src="{{ asset('frontend/assets/img/icons-svg/rev.png') }}" alt="quote">
                                </div>
    ...
    <section class="course-instructor-support-area bg-light section-t-space {{ @$home->instructor_support_area == 1 ? '' : 'd-none' }}">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center">
                        <h3 class="section-heading" style="color:#fff !important;">{{ __(@$aboutUsGeneral->instructor_support_title) }}</h3>
