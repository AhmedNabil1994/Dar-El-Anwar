...
{{--                                <h1 class="color-purple">{{$total_subscription}}</h1>--}}
{{--                                <h2>{{ trans('اشتراكاتي') }}</h2>--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                            <a href="{{route('student.index')}}">--}}
{{--                                <h1 class="color-purple">{{$total_subjects}}</h1>--}}
{{--                                <h2>{{ trans('موادي') }}</h2>--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                            <a href="{{route('student.index')}}">--}}
{{--                                <h1 class="color-purple">{{$class_room}}</h1>--}}
{{--                                <h2>{{ trans('فصل') }}</h2>--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                            <a href="{{route('student.index')}}">--}}
{{--                                <h1 class="color-purple">{{$courses}}</h1>--}}
{{--                                <h2>{{ trans('مواعيدي') }}</h2>--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
