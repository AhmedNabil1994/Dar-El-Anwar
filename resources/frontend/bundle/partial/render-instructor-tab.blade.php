<div class="tab-pane fade" id="Instructor" role="tabpanel" aria-labelledby="Instructor-tab">
    <div class="row">
        ...
        <div class="col-md-7 col-lg-12 col-xl-7 p-0">
            <div class="meet-your-instructor-left d-flex">
                ...
                <div class="flex-grow-1">
                    <p class="font-medium color-heading mb-1">{{ __(@$bundle->user->instructor->name) }}</p>
                    <p class="font-12 mb-2">{{ __(@$bundle->user->instructor->professional_title) }}</p>
        ...
        <div class="col-md-5 col-lg-12 col-xl-5 p-0">
            <div class="meet-your-instructor-right">
                <div class="d-flex">
                    ...
                    <div>
                        <div class="meet-instructor-extra-info-item color-heading"><span class="iconify" data-icon="cil:badge"></span>{{ get_instructor_ranking_level(@$bundle->user->instructor->user_id) }}
                        </div>
                        <div class="meet-instructor-extra-info-item color-heading"><span class="iconify" data-icon="ph:monitor-light"></span>{{ @$bundle->user->instructor->courses->count() }} {{ __('Courses') }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 meet-your-instructor-content-part">
            ...
            <p>{{ __(@$bundle->user->instructor->about_me) }}</p>
        </div>
    </div>
</div>
