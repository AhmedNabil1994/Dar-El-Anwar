        ...
        <div class="card course-item courses-bundles-course-item radius-3 bg-white">
            ...
            <div class="card-body">
                ...
                <p class="card-text instructor-name-certificate font-medium font-12">
                    {{ @$bundleCourse->course->instructor->name }}
                    @if(get_instructor_ranking_level(@$bundleCourse->course->instructor->user_id))
                        | {{ get_instructor_ranking_level(@$bundleCourse->course->instructor->user_id) }}
                    @endif
                </p>
