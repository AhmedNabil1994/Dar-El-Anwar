                ...
                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                    <div class="accordion-body">
                        <div class="range-value-box">
                            ...
                            <div class="range-value-wrap d-flex align-items-center">
                                <button type="button" class="filterSearchName"><i class="fas fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion-body">
                        <div class="range-value-box">
                            ...
                            <div class="range-value-wrap-go-btn d-flex align-items-center">
                                <button type="button" class="filterHourlyRate"><i class="fas fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
