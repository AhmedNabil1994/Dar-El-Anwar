    ...
    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
        <div class="card course-item consultation-instructor-item border-0 radius-3 bg-white">
            ...
            <div class="card-body position-relative">
                ...
                <p class="card-text instructor-name-certificate font-medium font-12">{{ $consultationInstructor->professional_title }} @if(get_instructor_ranking_level(@$consultationInstructor->user_id))
