...
@section('content')
    ...
    <div class="bg-page">
        ...
        <header class="page-banner-header gradient-bg position-relative">
            <div class="section-overlasy">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="page-banner-content text-center">
                                <h3 class="page-banner-heading text-white pb-15">{{ __($subcategory->name) }}</h3>

                                <!-- Breadcrumb Start-->
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item font-14"><a href="{{ url('/') }}">{{ __('Home') }}</a></li>
                                        <li class="breadcrumb-item font-14"><a href="#">{{ __('Subcategory') }}</a></li>
                                        <li class="breadcrumb-item font-14 active" aria-current="page">{{ __($subcategory->name) }}</li>
                                    </ol>
                                </nav>
                                <!-- Breadcrumb End-->
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="filter-bar-right col-lg-4 text-end">
                                    <div class="filter-bar-left-top color-gray mb-3 d-none">
                                        <span class="color-heading">{{ __('Search result for') }}:</span> <span class="color-hover">“{{ __($subcategory->name) }}”</span>
