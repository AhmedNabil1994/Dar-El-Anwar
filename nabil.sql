...
--
-- Table structure for table `class_instructor_subjects`
--

CREATE TABLE `class_instructor_subjects` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `instructor_subjects_id` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `class_instructor_subjects`
--

INSERT INTO `class_instructor_subjects` (`id`, `instructor_subjects_id`, `class_room_id`, `created_at`, `updated_at`) VALUES
(1, 1, 15, NULL, NULL),
(3, 4, 15, NULL, NULL),
(4, 2, 17, NULL, NULL),
(6, 1, 16, NULL, NULL),
...
(18, NULL, 'فصل اول', NULL, 1, NULL, NULL, 12, NULL, 2, NULL, NULL, NULL, NULL, NULL, 'uploaded_video', 1, NULL, NULL, NULL, NULL, NULL, '2023-10-11 09:09:49', '2023-10-11 09:09:49'),
(19, NULL, 'فصل ثان', NULL, 0, NULL, NULL, 12, NULL, 2, NULL, NULL, NULL, NULL, NULL, 'uploaded_video', 1, NULL, NULL, NULL, NULL, NULL, '2023-10-11 09:10:30', '2023-10-11 09:10:50');
...
(22, '9a8ceb57-e6d8-4d1f-8683-e6f2678cbf1b', 'قسم اول', NULL, 'no', NULL, 1, '2023-10-11 07:23:49', '2023-10-11 07:23:49');
...
INSERT INTO `instructor_subjects` (`id`, `instructor_id`, `subject_id`, `created_at`, `updated_at`) VALUES
(1, 6, 9, NULL, NULL),
(2, 10, 9, NULL, NULL),
(3, 6, 7, NULL, NULL),
(4, 10, 7, NULL, NULL),
...
(178, '2023_10_11_111425_create_instructor_subjects_table', 28),
(179, '2023_10_11_112851_create_class_instructor_subjects_table', 29);
...
(6, 'مادة اولي', NULL, 10, '2023-10-11 08:06:42', '2023-10-11 08:06:42'),
(7, 'مادة ثانية', NULL, 10, '2023-10-11 08:07:00', '2023-10-11 08:07:00'),
(9, 'مادة ثالثة', NULL, NULL, '2023-10-11 08:18:35', '2023-10-11 08:18:35'),
(10, 'مادة اولي', NULL, NULL, '2023-10-11 09:10:12', '2023-10-11 09:10:12');
...
--
-- Indexes for table `class_instructor_subjects`
--
ALTER TABLE `class_instructor_subjects`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `class_instructor_subjects`
--
ALTER TABLE `class_instructor_subjects`
